    ...
    <header class="navbar navbar-sticky">
      ...
      <div class="site-branding">
        <div class="inner">
          ...
          <!-- Site Logo--><a class="site-logo" href="<?= base_url() ?>home/index"><img src="<?= base_url() ?>plantilla/img/logo/logoNaty.png" alt="Unishop"></a>
        </div>
      </div>
      <style>
...
.site-menu ul>li:hover>a { color: #ff914d; }
      ...
      <nav class="site-menu">
        <ul>
          <li class="has-megamenu"><a href="<?= base_url() ?>home/index" >
            <span >INICIO</span></a>
            <!--
            <ul class="mega-menu">
        ...
        <div class="inner">
          ...
          <!--  <div class="search"><i class="icon-search"></i></div> -->
            <div class="account"><a href="#"></a><i class="icon-head"></i>
              ...
              -->
                <li><a href="<?=base_url()?>auth" style="color: #ff914d">Login</a></li>
              </ul>
            </div>
            <!--
            <div class="cart"><a href="cart.html"></a><i class="icon-bag"></i><span class="count">3</span><span class="subtotal">$289.68</span>
              <div class="toolbar-dropdown">
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="/plantilla/img/cart-dropdown/01.jpg" alt="Product"></a>
                ...
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="/plantilla/img/cart-dropdown/02.jpg" alt="Product"></a>
                ...
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="/plantilla/img/cart-dropdown/03.jpg" alt="Product"></a>
