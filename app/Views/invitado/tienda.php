<?php 
 echo view("invitado/estructuraTienda/cabecera");
 echo view("invitado/estructuraTienda/filtros_modal");
 echo view("invitado/estructuraTienda/promocion_modal");
 echo view("invitado/estructuraTienda/barralateral");
 echo view("invitado/estructuraTienda/barralateralmovil");
 echo view("invitado/estructuraTienda/navbar");
?>
...
<?php 
 echo view("invitado/estructuraTienda/modal");
?>
                ...
                <div class="col-lg-4 margin-bottom-1x">
                  <div class="card text-center">
                    ...
                    <div class="card-body">
                      ...
                      <button  class="adcar btn btn-outline-warning btn-sm" >
                            Añadir 
...
<?php 
 echo view("invitado/estructuraTienda/filtros");
 echo view("invitado/estructuraTienda/promocion");
?>
...
<script>
  $(document).ready(function(){
      ...
      $("select[name=ver]").change(function(){
        ...
        history.pushState(null, "", base_url + '/invitado/filtroVista?vista='+valor);
        location.reload();
        /* if(valor != 0){
          $.ajax({
              type: 'POST',
        ...
        $(document).on('click', ".mostrar", function() { 
          var base_url = '<?php echo base_url(); ?>';
            var vari = $(this).attr("valor");
                ...
                $.ajax({
                    type: 'POST',
                    url: base_url + 'invitado/mostrarProducto',
                    ...
                    success: function(resp){          
                      ...
                      $("#catego").attr('href', base_url+'/invitado/filtroCategoria?categoria='+resp.categoria);
                      $("#marc").html(resp.marca);
                      $("#marc").attr('href', base_url+'/invitado/filtroMarca?marca='+resp.marca);
                    },
                    error: function(e){
                      console.log(e)
                    }
      ...
      $(document).ready(function(){
        $(document).on('click', ".adcar", function() {
                    toastr.error('Necesita Cuenta!!','Alerta',
                                  {"closeButton": false,
                                  "debug": false,
                                  "newestOnTop": false,
                                  "progressBar": true,
    ...
    $(document).ready(function(){
      $(document).on('click', ".aggre", function() { 
          $("#cerr").click();
          $("#vacant").val('');
          toastr.error('Necesita Cuenta!!','Alerta',
                      {"closeButton": false,
...
*/
 ...
 <?php //} ?>
      ...
      <?php 
 echo view("invitado/estructuraTienda/footer");
 ?>