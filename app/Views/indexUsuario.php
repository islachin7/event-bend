...
?>
    ...
    <div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="#">
        ...
        <div class="user-ava"><img src="<?=base_url()?>plantilla/img/account/user-ava-md.jpg" alt="Daniel Adams">
        </div>
         
        <div class="user-info">
          <h6 class="user-name">Categorias</h6>
      ...
      <nav class="offcanvas-menu">
        <ul class="menu">
          <li class="has-children active"><span><a href="index-2.html"><span>Home</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
                <li class="active"><a href="index-2.html">Featured Products Slider</a></li>
          ...
          <li class="has-children"><span><a href="<?=base_url()?>auth"><span>Account</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
    ...
    <header class="navbar navbar-sticky">
      ...
      <div class="site-branding">
        <div class="inner">
          ...
          <!-- Site Logo--><a class="site-logo" href="index-2.html"><img src="<?=base_url()?>plantilla/img/logo/logoNaty.png" alt="Unishop"></a>
        </div>
      </div>
      <style>
...
.site-menu ul>li:hover>a { color: #ff914d; }
      ...
      <nav class="site-menu">
        <ul>
          <li class="has-megamenu active"><a href="<?= base_url() ?>home/index" style="border-top-color: #ff914d;">
            <span style="color: #ff914d">INICIO</span></a>
            <!--
            <ul class="mega-menu">
          ...
          <li><a href="<?= base_url() ?>tienda/" ><span id="link">TIENDA</span></a>
            <ul class="sub-menu">
                <li><a href="shop-categories.html">Shop Categories</a></li>
...
-->
  ...
  <!--
          ...
          <div class="tools">
            ...
            <div class="account"><a href="#"></a><i class="icon-head"></i>
              <ul class="toolbar-dropdown">
                ...
                <li><a href="<?= base_url() ?>auth/logout"> <i class="icon-unlock"></i>Logout</a></li>
              </ul>
            </div>

            <div class="cart"><a href="cart.html"></a><i class="icon-bag"></i><span id="subconteo" class="count"><?php echo isset($cont)? $cont:"" ; ?></span><span class="subtotal" id="subtotalito">S/ <?php echo isset($total)? $total:"" ; ?></span>
              <div class="toolbar-dropdown" id="carrito">
                ...
                <div class="dropdown-product-item"><span class="dropdown-product-remove"><i class="icon-cross"></i></span><a class="dropdown-product-thumb" href="shop-single.html"><img src="<?=base_url()?>plantilla/fotoProducto/<?=$fila2->imagen?>" alt="Product"></a>
                  <div class="dropdown-product-info"><a class="dropdown-product-title" ><?=$fila2->titulo?></a><span class="dropdown-product-details"><?php echo $fila2->cantidad?> x <?php echo $fila2->precio?> = S/ <?php echo $fila2->cantidad*$fila2->precio?></span></div>
                </div>
                <?php } ?>
                  <?php endif; ?>
    ...
    <div class="offcanvas-wrapper">
      <!-- Page Content-->
      <!-- Main Slider-->
      <section class="hero-slider" style="background-image: url(<?=base_url()?>plantilla/img/hero-slider/fondomain_03.jpg);">
        <div class="owl-carousel large-controls dots-inside" data-owl-carousel="{ &quot;nav&quot;: true, &quot;dots&quot;: true, &quot;loop&quot;: true, &quot;autoplay&quot;: true, &quot;autoplayTimeout&quot;: 7000 }">
          <div class="item">
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block w-150 mb-4" src="<?=base_url()?>plantilla/img/hero-slider/logo02.png" alt="Puma">
                  ...
                  </div><a class="btn btn-warning scale-up delay-1" href="shop-grid-ls.html">View Offers</a>
                </div>
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?=base_url()?>plantilla/img/hero-slider/02.png" alt="Puma Backpack"></div>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block w-200 mb-4" src="<?=base_url()?>plantilla/img/hero-slider/logo01.png" alt="Converse">
                  ...
                  </div><a class="btn btn-warning scale-up delay-1" href="shop-single.html">Shop Now</a>
                </div>
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?=base_url()?>plantilla/img/hero-slider/01.png" alt="Chuck Taylor All Star II"></div>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block mb-4" src="<?=base_url()?>plantilla/img/hero-slider/logo03.png" style="width: 125px;" alt="Motorola">
                ...
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?=base_url()?>plantilla/img/hero-slider/03.png" alt="Moto 360"></div>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="container padding-top-3x">
              <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-md-6 padding-bottom-2x text-md-left text-center">
                  <div class="from-bottom"><img class="d-inline-block mb-4" src="<?=base_url()?>plantilla/img/hero-slider/logoNaty01.png" style="width: 125px;" alt="Motorola">
                    <div class="h2 text-body text-normal mb-2 pt-1">que sale</div>
                    <div class="h2 text-body text-normal mb-4 pb-1">haber <span class="text-bold">$299.99</span></div>
                  </div><a class="btn btn-warning scale-up delay-1" href="shop-single.html">Shop Now</a>
                </div>
                <div class="col-md-6 padding-bottom-2x mb-3"><img class="d-block mx-auto" src="<?=base_url()?>plantilla/img/hero-slider/07.png" alt="Moto 360"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                <div class="inner">
                  <div class="main-img"><img src="<?=base_url()?>plantilla/img/shop/categories/01.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="<?=base_url()?>plantilla/img/shop/categories/02.jpg" alt="Category"><img src="<?=base_url()?>plantilla/img/shop/categories/03.jpg" alt="Category"></div>
                </div></a>
              <div class="card-body text-center">
                <h4 class="card-title">Clothing</h4>
                <p class="text-muted">Starting from $49.99</p><a class="btn btn-outline-warning btn-sm" href="shop-grid-ls.html">View Products</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                <div class="inner">
                  <div class="main-img"><img src="<?=base_url()?>plantilla/img/shop/categories/04.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="<?=base_url()?>plantilla/img/shop/categories/05.jpg" alt="Category"><img src="<?=base_url()?>plantilla/img/shop/categories/06.jpg" alt="Category"></div>
                </div></a>
              <div class="card-body text-center">
                <h4 class="card-title">Shoes</h4>
                <p class="text-muted">Starting from $56.00</p><a class="btn btn-outline-warning btn-sm" href="shop-grid-ls.html">View Products</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="card mb-30"><a class="card-img-tiles" href="shop-grid-ls.html">
                <div class="inner">
                  <div class="main-img"><img src="<?=base_url()?>plantilla/img/shop/categories/07.jpg" alt="Category"></div>
                  <div class="thumblist"><img src="<?=base_url()?>plantilla/img/shop/categories/08.jpg" alt="Category"><img src="<?=base_url()?>plantilla/img/shop/categories/09.jpg" alt="Category"></div>
                </div></a>
              <div class="card-body text-center">
                <h4 class="card-title">Bags</h4>
                <p class="text-muted">Starting from $27.00</p><a class="btn btn-outline-warning btn-sm" href="shop-grid-ls.html">View Products</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="container-fluid padding-top-3x">
        <div class="row justify-content-center">
          ...
          <div class="col-xl-5 col-lg-6 mb-30" style="min-height: 270px;">
            <div class="img-cover rounded" style="background-image: url(/plantilla/img/banners/home01.jpg);"></div>
          </div>
        </div>
      </section>
    -->
    ...
    -->
        ...
        <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: false, &quot;dots&quot;: true, &quot;margin&quot;: 30, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;576&quot;:{&quot;items&quot;:2},&quot;768&quot;:{&quot;items&quot;:3},&quot;991&quot;:{&quot;items&quot;:4},&quot;1200&quot;:{&quot;items&quot;:4}} }">
          ...
          <div class="grid-item">
            <div class="product-card">
                ...
                </div><a class="product-thumb" href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/products/03.jpg" alt="Product"></a>
          ...
          <!-- Product-->
          <div class="grid-item">
            <div class="product-card"><a class="product-thumb" href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/products/12.jpg" alt="Product"></a>
          ...
          <div class="grid-item">
            <div class="product-card">
                ...
                </div><a class="product-thumb" href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/products/11.jpg" alt="Product"></a>
          ...
          <!-- Product-->
          <div class="grid-item">
            <div class="product-card"><a class="product-thumb" href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/products/04.jpg" alt="Product"></a>
          ...
          <div class="grid-item">
            <div class="product-card">
              <div class="product-badge text-danger">50% Off</div><a class="product-thumb" href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/products/01.jpg" alt="Product"></a>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <div class="widget widget-featured-products">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/01.jpg" alt="Product"></a></div>
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/03.jpg" alt="Product"></a></div>
                <div class="entry-content">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/04.jpg" alt="Product"></a></div>
                <div class="entry-content">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="widget widget-featured-products">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/05.jpg" alt="Product"></a></div>
                <div class="entry-content">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/06.jpg" alt="Product"></a></div>
                <div class="entry-content">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/07.jpg" alt="Product"></a></div>
                <div class="entry-content">
          ...
          <div class="col-md-4 col-sm-6">
            <div class="widget widget-featured-products">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/08.jpg" alt="Product"></a></div>
                <div class="entry-content">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/09.jpg" alt="Product"></a></div>
                <div class="entry-content">
              ...
              <!-- Entry-->
              <div class="entry">
                <div class="entry-thumb"><a href="shop-single.html"><img src="<?=base_url()?>plantilla/img/shop/widget/10.jpg" alt="Product"></a></div>
                <div class="entry-content">
      ...
      <section class="bg-faded padding-top-3x padding-bottom-3x">
        <div class="container">
          ...
          <div class="owl-carousel" data-owl-carousel="{ &quot;nav&quot;: false, &quot;dots&quot;: false, &quot;loop&quot;: true, &quot;autoplay&quot;: true, &quot;autoplayTimeout&quot;: 4000, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:2}, &quot;470&quot;:{&quot;items&quot;:3},&quot;630&quot;:{&quot;items&quot;:4},&quot;991&quot;:{&quot;items&quot;:5},&quot;1200&quot;:{&quot;items&quot;:4}} }"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/01.png" alt="Adidas"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/02.png" alt="Brooks"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/03.png" alt="Valentino"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/04.png" alt="Nike"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/05.png" alt="Puma"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/06.png" alt="New Balance"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/07.png" alt="Dior"><img class="d-block w-110 opacity-50 m-auto" src="<?=base_url()?>plantilla/img/brands/esika.png" alt="Dior"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/unique.png" alt="Dior"><img class="d-block w-110 opacity-75 m-auto" src="<?=base_url()?>plantilla/img/brands/santaNatura.png" alt="Dior"></div>
        </div>
      </section>
      <!-- Services-->
      <!--
      <section class="container padding-top-3x padding-bottom-2x">
        <div class="row">
          <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/plantilla/img/services/01.png" alt="Shipping">
            <h6>Free Worldwide Shipping</h6>
            <p class="text-muted margin-bottom-none">Free shipping for all orders over $100</p>
          </div>
          <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/plantilla/img/services/02.png" alt="Money Back">
            <h6>Money Back Guarantee</h6>
            <p class="text-muted margin-bottom-none">We return money within 30 days</p>
          </div>
          <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/plantilla/img/services/03.png" alt="Support">
            <h6>24/7 Customer Support</h6>
            <p class="text-muted margin-bottom-none">Friendly 24/7 customer support</p>
          </div>
          <div class="col-md-3 col-sm-6 text-center mb-30"><img class="d-block w-90 img-thumbnail rounded-circle mx-auto mb-3" src="/plantilla/img/services/04.png" alt="Payment">
        ...
        <div class="container">
          <div class="row text-center">
            <div class="col-lg-6 col-md-6">
              ...
              <section class="widget widget-light-skin">
                ...
                <p><a class="navi-link-light" href="#">naty@gmail.com</a></p>
          ...
          <div class="row">
            <div class="col-md-7 padding-bottom-1x">
              <!-- Payment Methods-->
              <div class="margin-bottom-1x" style="max-width: 615px;"><img src="<?=base_url()?>plantilla/img/payment_methods.png" alt="Payment Methods">
              </div>
            </div>
              ...
              <form class="subscribe-form" action="http://rokaux.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;amp;id=1194bb7544" method="post" target="_blank" novalidate>
                <div class="clearfix">
                  <div class="input-group input-light">
                    <input class="form-control" type="email" name="EMAIL" placeholder="Tu Correo"><span class="input-group-addon"><i class="icon-mail"></i></span>
                  </div>
                  <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                  <div style="position: absolute; left: -5000px;" aria-hidden="true">
                    <input type="text" name="b_c7103e2c981361a6639545bd5_1194bb7544" tabindex="-1">
                  </div>
                  <button class="btn btn-warning" type="submit"><i class="icon-check"></i></button>
                </div><span class="form-text text-sm text-white opacity-50">
                  Envianos tu correo para poder enviarte información y ofertas!!
                </span>
              </form>
            </div>
          </div>
